...
public class BanderoGusakBot extends TelegramLongPollingBot {
    private Map<Long, Integer> levels = new HashMap<>();

    public static void main(String[] args) throws TelegramApiException {
        TelegramBotsApi api = new TelegramBotsApi(DefaultBotSession.class);
        api.registerBot(new BanderoGusakBot());
    }

    @Override
    public String getBotUsername() {
        return "BanderosGusakBot";
    }

    @Override
    public String getBotToken() {
        return "6410779499:AAG5ozA4YbJQsJ9y2_su12F4CFjV67hf0Wg";
    }
    ...
    public void onUpdateReceived(Update update) {
        ...
        if (update.hasMessage() && update.getMessage().getText().equals("/start")) {
            ...
            SendMessage msg = createMessage("Ґа-ґа-ґа!\n" +
            ...
            attachButtons(msg, Map.of(buttons.get(0), "level_1_task",
        ...
        if (update.hasCallbackQuery()) {
            if (update.getCallbackQuery().getData().equals("level_1_task") && getLevel(chatId) == 1) {
                ...
                SendMessage msg = createMessage("*Вітаємо на другому рівні! Твій гусак - біогусак.*\n" +
                        "Баланс: 20 монет. \n" +
                        "Обери завдання, щоб перейти на наступний рівень");
                msg.setChatId(chatId);
                ...
                attachButtons(msg, Map.of(buttons.get(0), "level_2_task",
            ...
            if (update.getCallbackQuery().getData().equals("level_2_task") && getLevel(chatId) == 2) {
                ...
                SendMessage msg = createMessage("*Вітаємо на третьому рівні! Твій гусак - бандеростажер.*\n" +
                        "Баланс: 35 монет. \n" +
                        "Обери завдання, щоб перейти на наступний рівень");
                msg.setChatId(chatId);
                ...
                attachButtons(msg, Map.of(buttons.get(0), "level_3_task",
            ...
            if (update.getCallbackQuery().getData().equals("level_3_task") && getLevel(chatId) == 3) {
                ...
                SendMessage msg = createMessage("*Вітаємо на останньому рівні! Твій гусак - готова біологічна зброя - бандерогусак.*\n" +
                        "Баланс: 50 монет. \n" +
                        "Тепер ти можеш придбати Джавелін і глушити чмонь");
                msg.setChatId(chatId);

                attachButtons(msg, Map.of("Купити Джавелін (50 монет)", "level_4_task"));
            ...
            if (update.getCallbackQuery().getData().equals("level_4_task") && getLevel(chatId) == 4) {
                ...
                SendMessage msg = createMessage("*Джавелін твій. Повний вперед!*");
                msg.setChatId(chatId);
